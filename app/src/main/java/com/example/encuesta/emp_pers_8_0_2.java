 ...
 * {@link emp_pers_8_0_2.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link emp_pers_8_0_2#newInstance} factory method to
 * create an instance of this fragment.
 */
public class emp_pers_8_0_2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        idFragment=(TextView) vista.findViewById(R.id.idemppers802);
        txtrespuesta=(EditText) vista.findViewById(R.id.txtRegUnaSolResp82);
        display=(LinearLayout) vista.findViewById(R.id.layout82);
    ...
    private void cargarWebServices() {
        try {
            ...
            String[] parametros={idFragment.getText().toString()};
            String [] campos={"respuesta_tomar_desicion"};
    ...
    private void actualizar(String pantalla) {
        try {
            ...
            values.put("respuesta_tomar_desicion", txtrespuesta.getText().toString());
