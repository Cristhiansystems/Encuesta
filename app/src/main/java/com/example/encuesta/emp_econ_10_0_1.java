...
public class emp_econ_10_0_1 extends Fragment {
    ...
    private void cargarWebServices() {
        ...
        String [] campos={"empleo"
                ,"emprendimiento"
                ,"proyecto_social"
                ,"estoy_realizando"
                ,"otro_actividad_ingreso"
                ,"otro_actividad_ingreso_nombre"
                ,"opotunidad_realizar_emprendimiento"
                ,"menciona_tipo_emprendimiento"};

        Cursor cursor=db.query("encuesta_emt",campos,"encuesta_emt=?",parametros,null,null,null);
        cursor.moveToFirst();

        empleo =Integer.parseInt( cursor.getString(0));
        emprendimiento =Integer.parseInt(  cursor.getString(1));
        social =Integer.parseInt(  cursor.getString(2));
        realizando =Integer.parseInt(  cursor.getString(3));
        otro =Integer.parseInt(  cursor.getString(4));

        otronom  = cursor.getString(5);

        oportunidadEmprendimiento =Integer.parseInt(  cursor.getString(6));
        tipoemprendimiento =cursor.getString(7);
    ...
    private void actualizar(String pantalla) {
        ...
        try {
           ...
           values.put("otro_actividad_ingreso_nombre", otronom);
            values.put("menciona_tipo_emprendimiento", tipoEmprendimiento);
            values.put("empleo", empleo);
            values.put("emprendimiento", emprendimiento);
            values.put("proyecto_social", social);
            values.put("estoy_realizando", realizando);
            values.put("otro_actividad_ingreso", otro);
            values.put("opotunidad_realizar_emprendimiento", oportunidad);
