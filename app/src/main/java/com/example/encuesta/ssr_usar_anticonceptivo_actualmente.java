...
public class ssr_usar_anticonceptivo_actualmente extends Fragment{
    ...
    Integer UsarAnticonceptivoActual;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        idFragment= (TextView) vista.findViewById(R.id.idUsarAnticonceptivosActualmente);

        //Radio Butons
        rdSi=(RadioButton) vista.findViewById(R.id.usarAnticonceptivoActualSi);
        rdNo=(RadioButton) vista.findViewById(R.id.usarAnticonceptivoActualNo);
        rdNoSabe=(RadioButton) vista.findViewById(R.id.usarAnticonceptivoActualNosabe);
    ...
    private void actualizar(String pantalla) {
        ...
        stringRequest=new StringRequest(Request.Method.POST, url, response -> {
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                String usarAnticonceptivoActual = "0";
                if (rdSi.isChecked()) {
                    usarAnticonceptivoActual = "1";
                } else if (rdNo.isChecked()) {
                    usarAnticonceptivoActual = "2";
                }else if (rdNoSabe.isChecked()) {
                    usarAnticonceptivoActual = "3";
                }
